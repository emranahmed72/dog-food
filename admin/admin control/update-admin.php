<?php
    ...
    if(isset($_POST['update'])){
        ...
        $query = "UPDATE `admin` SET `id`='$id',`user_name`='$user_name',`password`='$password' WHERE `id`='$id' ";
...
<body>
  <div class="container">
    <div class="h1"><h1>Update Admin Info</h1></div>
    <br>
    <div class="content">
      <form action="update-admin.php" method="post" style="border:1px solid #ccc">
        <div class="container">
          <div class="input-box">
            <span class="details">Enter Admin Unique Id</span>
            <input type="text" name="id" placeholder="Enter Id">
          </div>
          <div class="input-box">
            <span class="details">New Admin Name</span>
      ...
      <div>
          <a href="admin-control.php" class="btn"><h3>Back To Previous Page</h3></a>
        </div>
...
<!-- SELECT `id`, `user_name` FROM `admin`; -->