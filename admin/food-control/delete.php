...
session_start();
    ...
    {   
        ...
        $sql = " DELETE FROM `dog food` WHERE `id`='$id';";
...
<body>
  <div class="container">
    <div class="h1"><h1>Delete Food Item</h1> </div>
    <div class="content">
      <form action="delete.php" method="post" autocomplete="off" enctype="multipart/form-data" style="border:1px solid #ccc" >
        <div class="Food-add-details">
        <div class="input-box">
            <span class="details">Id        </span>
            <input type="text" name="id" placeholder="Enter Food Unique Id" required><br><br>
          </div>
