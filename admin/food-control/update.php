<?php
    ...
    if(isset($_POST['update'])){
        ...
        $query = "UPDATE `dog food` SET `id`='$id',`food_name`='$food_name',`description`='$description',`price`='$price',`image`='$image' WHERE `id`='$id' ";
        ...
        if($result)
        {
            ...
            echo '<script type="text/javascript">alert("food Not Updated")</script>';
...
<body>
  <div class="container">
    <div class="h1"><h1>Update Food Item</h1> </div>
    <div class="content">
      <form action="update.php" method="post" autocomplete="off" enctype="multipart/form-data" style="border:1px solid #ccc" >
        <div class="Food-add-details">
        <div class="input-box">
            <span class="details">Id        </span>
            <input type="text" name="id" placeholder="Enter Food Id" required><br><br>
          </div>
        <div class="input-box">
...
if(mysqli_num_rows($result)>0){
  foreach($result as $row)
  {
      ...
      <td colspan="3"><img src="images/<?php echo $row['image'];?>" alt="not found" width="200" height="200"  ></td>
